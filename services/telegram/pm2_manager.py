...
def start_bot_pm2(
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            # Persist the PM2 dump immediately — without this, a daemon
            # restart (reboot / pm2 update) resurrects only saved processes
            # and silently drops this bot (exactly what happened to
            # dreamlead-z95we3-bot: process gone, publishes kept "succeeding").
            try:
