...
_ESCALATION_PATTERNS = [
    r"\b(talk|speak|chat) (to|with) (a )?(human|person|support|someone|admin|agent)\b",
    r"\b(human|real person|support team|customer support)\b.*\b(help|assist|take over)\b",
