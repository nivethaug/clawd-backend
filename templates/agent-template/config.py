#!/usr/bin/env python3
"""
Configuration - Environment variables for the automation agent project.
...
# Per-project platform key: authenticates proxy_call() against the
# DreamAgent integrations proxy (connected OAuth accounts act as actions).
