...
def init_schema():
    ...
    try:
        ...
        with conn.cursor() as cur:
            ...
            # --- api_keys (revocable personal tokens for MCP/ChatGPT connectors) ---
            cur.execute("""CREATE TABLE IF NOT EXISTS api_keys (
                id SERIAL PRIMARY KEY,
                user_id INTEGER NOT NULL REFERENCES users(id) ON DELETE CASCADE,
                name VARCHAR(100) NOT NULL DEFAULT 'ChatGPT',
                key_hash TEXT NOT NULL UNIQUE,
                key_prefix VARCHAR(12) NOT NULL,
                scopes JSONB NOT NULL DEFAULT '["projects:read","projects:write","chat:write"]',
                created_at TIMESTAMP DEFAULT NOW(),
            ...
            seed_plans = [
                ('free', 'Free', 0, 3, 0, 0, 0, 0, 0, 0, False, 0,
                 json.dumps(["3 Active Projects", "2M AI Tokens",
                             "50 Monthly Project AI Credits", "Unlimited Prompt Assistant",
                             "Unlimited AI DevOps Assistant", "Telegram, Discord & Slack",
                             "Full Source Code", "Version History & Rollback", "GitHub Export"])),
