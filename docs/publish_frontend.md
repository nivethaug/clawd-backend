...
Builds and publishes the frontend for a project by running the project's `frontend/buildpublish.py`.
...
3. Resolves `{project_path}/frontend`.
4. Requires `package.json`.
5. Runs `python3 buildpublish.py` in the frontend directory.
